...
- 不具合は GitHub Issues の「不具合報告」テンプレートへ: https://github.com/karak/ai-game-hackathon-sample/issues/new/choose （リポジトリ: https://github.com/karak/ai-game-hackathon-sample）
