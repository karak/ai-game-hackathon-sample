...
export async function render(main, A) {
  ...
  main.appendChild(frameStrip([{ name: 'hat', spr: A.hat, size: true }, ...(A.broom ? [{ name: 'broom', spr: A.broom }, { name: 'broom2', spr: A.broom2 }] : [])], { gap: 16 })); // ほうきは HD 素材ができるまで無し（BUG-024）→ props/broom・broom2（2026-09-13）
