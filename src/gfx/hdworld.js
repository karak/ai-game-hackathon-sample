...
export const TILE_BANDS = {
  ...
  park:        { surface: [0.00, 0.15], plat: [0.17, 0.26], fill: [0.28, 0.98] }, // 実測（268×173）: 頭蓋骨の舗道 0〜0.14、骨板 0.17〜0.25、地中 0.28〜 // 実測（263×114、内容 bbox 切詰済）: 雪の板床 0〜0.19、石壁の地中 0.22〜 // 実測: 0〜0.25 はキー残り、草 0.26〜0.31、泥と水溜まり 0.31〜0.47、草の線 0.48〜0.50、地中 0.51〜
};
