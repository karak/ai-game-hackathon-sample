...
export const TILE_BANDS = {
  ...
  river:       { surface: [0.26, 0.32], plat: [0.47, 0.52], fill: [0.53, 0.98] },
  workshop:    { surface: [0.00, 0.19], plat: [0.05, 0.18], fill: [0.22, 0.96] }, // 実測（263×114、内容 bbox 切詰済）: 雪の板床 0〜0.19、石壁の地中 0.22〜 // 実測: 0〜0.25 はキー残り、草 0.26〜0.31、泥と水溜まり 0.31〜0.47、草の線 0.48〜0.50、地中 0.51〜
};
