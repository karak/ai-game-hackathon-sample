...
export const TILE_BANDS = {
  ...
  tower:       { surface: [0.00, 0.16], plat: [0.22, 0.40], fill: [0.44, 0.98] }, // 実測（247×99）: 銀象嵌の床 0〜0.15、石段 0.22〜0.40、石壁 0.44〜 // 実測（268×173）: 頭蓋骨の舗道 0〜0.14、骨板 0.17〜0.25、地中 0.28〜 // 実測（263×114、内容 bbox 切詰済）: 雪の板床 0〜0.19、石壁の地中 0.22〜 // 実測: 0〜0.25 はキー残り、草 0.26〜0.31、泥と水溜まり 0.31〜0.47、草の線 0.48〜0.50、地中 0.51〜
};
