...
| **描画基盤**（Graphics） | `src/gfx/` | 生成素材の読み込みと切り出し、パレット、HD スプライトの blit、地形帯からのタイル合成、背景層、読めない素材のプレースホルダ（ADR-0040。文字列ドット絵のフォールバックは DEBT-003 で撤去） | `assets.js`、`loader.js`、`sprite.js`、`palette.js`、`tiles.js`、`hdworld.js`、`background.js` |
